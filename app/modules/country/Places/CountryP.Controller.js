discovrApp.controller('CountryP.IndexController', function(
    $localStorage,
    $location,
    ...
    var slides = $scope.slides = [{
            image: '../../assets/files/img/main/Nicaragua/1.jpg',
            id: 0,
            name: "Playa de San Juan del Sur/Rivas"
        },
        {
            image: '../../assets/files/img/main/Nicaragua/2.jpg',
            id: 1,
            name: "Catedral de Granada/Granada"
        },
        {
            image: '../../assets/files/img/main/Nicaragua/3.jpg',
            id: 2,
            name: "El Cerro Negro/León"
        },
        {
            image: '../../assets/files/img/main/Nicaragua/4.jpeg',
            id: 3,
            name: "Isla de Ometepe/Ometepe"
        },
        {
            image: '../../assets/files/img/main/Nicaragua/5.jpg',
            id: 4,
            name: "El cañón de Somoto/Somoto"
        },
        {
            image: '../../assets/files/img/main/Nicaragua/6.jpg',
            id: 5,
